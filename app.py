...
/* Sortable headers */
th.sortable { cursor:pointer; user-select:none; } th.sortable:hover { color:var(--blue); } th.sortable::after { content:' *'; font-size:0.7em; opacity:0.4; } th.sorted-asc::after { content:' [A]'; opacity:1; color:var(--blue); } th.sorted-desc::after { content:' [D]'; opacity:1; color:var(--blue); }
